  ...
  return (
    <section className="my-16">
      <div className="flex flex-col mb-12 px-2 text-center items-center">
        <h2 className="text-3xl font-black tracking-tighter uppercase">Join the Community</h2>
      ...
      <div className="grid grid-cols-2 md:grid-cols-3 gap-8 justify-items-center">
        {Object.entries(statsData).map(([key, info]: [string, any]) => {
          ...
          // Unique ID for the SVG path so the text knows where to go
          ...
          return (
            <a
              ...
              className="group relative flex items-center justify-center w-40 h-40 transition-transform duration-500 hover:scale-110"
            >
              ...
              <div className="absolute inset-0 animate-[spin_10s_linear_infinite] group-hover:animate-[spin_4s_linear_infinite]">
                <svg viewBox="0 0 100 100" className="w-full h-full">
                  <path
                    ...
                    fill="none"
                  />
                  <text className="fill-zinc-400 dark:fill-zinc-500 text-[8px] font-bold uppercase tracking-[0.2em] transition-colors group-hover:fill-current">
